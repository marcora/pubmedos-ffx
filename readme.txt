...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\pubmedos on
     Windows, /home/user/dev/pubmedos on Linux) in a file named
     pubmedos@edoardo.marcora.net and copy that file to
